...
def predict():
    ...
    pred = round(pred[0],3)
    entry = Prediction(wind=mean1,vehicle=mean2,solar=mean3,garbage=mean4,evehicle=mean5,industries=mean6,forest=mean7,population=mean8,bio=mean9,recycle=mean10,thermal=mean11,buildings=mean12,nuclear=mean13,co2=pred);
